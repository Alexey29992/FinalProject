...
<c:choose>
    ...
    <c:when test="${requestScope.isNumberSet}">
        <form method="post" action="${pageContext.request.contextPath}/controller" class="request-form">
            <input type="hidden" name="command" value="create-request"/>
            <label>
                Description:<br/>
                <textarea name="description" class="textarea" placeholder="Describe your problem..."></textarea><br/>
            </label>
