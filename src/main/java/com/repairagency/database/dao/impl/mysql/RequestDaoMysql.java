...
public class RequestDaoMysql extends AbstractDao<Request> {
    ...
    private static final String GET_BASE = "SELECT request.*, status.status_name," +
    ...
    /**
     * Creates MySQL Request DAO on given {@link Connection}
     * @param connection Connection object to create DAO on it
     */
    public RequestDaoMysql(Connection connection) throws DBException {
        super(connection);
    }

    /**
     * Inserts given {@link Request} in the database
     * @param req Request to be inserted in the database
     * @return autogenerated ID of the inserted Request
    ...
    /**
     * Updates the database with given {@link Request} info
     * @param req Request to be updated in the database
     * @throws DBException if internal database errors occur
     */
    @Override
    ...
    /**
     * Deletes data of the {@link Request} with given ID from the database
    ...
    /**
     * Creates instance of {@link Request} from given ResultSet
     ...
     * Inserts given {@link Request} in the database
     * @param req Request to be inserted in the database
     * @param statusId internal database autogenerated Status ID of given Request
     * @return autogenerated ID of the inserted Request
     * @throws DBException if internal database errors occur
     */
    ...
    /**
     * Receives internal autogenerated database ID of given {@link Request.Status}.
     * Each Status in the database is unique, with its own ID.
     * @param status Status which ID is needed
     * @return ID of given Status
     * @throws DBException if internal database errors occur
     */
